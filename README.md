...
flowchart TD
    ...
    classDef apiClass fill:#dbeafe,stroke:#2563eb,color:#1e3a8a,font-weight:bold,font-size:14px,stroke-width:2.5px
    classDef storeClass fill:#e0f2fe,stroke:#0284c7,color:#0c4a6e,font-weight:bold,font-size:14px,stroke-width:2.5px
    classDef validateClass fill:#fef9c3,stroke:#ca8a04,color:#713f12,font-weight:bold,font-size:14px,stroke-width:3px
    classDef rejectClass fill:#fecaca,stroke:#dc2626,color:#7f1d1d,font-weight:bold,font-size:14px,stroke-width:3px
    classDef memClass fill:#e0e7ff,stroke:#4f46e5,color:#312e81,font-weight:bold,font-size:14px,stroke-width:2.5px
    classDef smemClass fill:#ddd6fe,stroke:#7c3aed,color:#4c1d95,font-weight:bold,font-size:14px,stroke-width:3px
    classDef streamClass fill:#c7d2fe,stroke:#4f46e5,color:#312e81,font-weight:bold,font-size:14px,stroke-width:2.5px
    classDef crewClass fill:#fef3c7,stroke:#b45309,color:#78350f,font-weight:bold,font-size:16px,stroke-width:3px
    classDef gemClass fill:#bfdbfe,stroke:#2563eb,color:#1e3a8a,font-weight:bold,font-size:14px,stroke-width:3px
    classDef srpClass fill:#bbf7d0,stroke:#16a34a,color:#14532d,font-weight:bold,font-size:14px,stroke-width:3px
    classDef oaiClass fill:#c7d2fe,stroke:#4f46e5,color:#312e81,font-weight:bold,font-size:14px,stroke-width:3px
    classDef feClass fill:#fef3c7,stroke:#b45309,color:#78350f,font-weight:bold,font-size:16px,stroke-width:3px
    classDef humanClass fill:#fce7f3,stroke:#db2777,color:#831843,font-weight:bold,font-size:14px,stroke-width:3px
    classDef postClass fill:#d1fae5,stroke:#059669,color:#064e3b,font-weight:bold,font-size:14px,stroke-width:3px
    classDef outClass fill:#dcfce7,stroke:#16a34a,color:#14532d,font-weight:bold,font-size:13px,stroke-width:2.5px
    classDef outPdfClass fill:#dbeafe,stroke:#2563eb,color:#1e3a8a,font-weight:bold,font-size:13px,stroke-width:2.5px
    classDef supaClass fill:#a7f3d0,stroke:#059669,color:#064e3b,font-weight:bold,font-size:14px,stroke-width:3px
    classDef slackClass fill:#fecaca,stroke:#dc2626,color:#7f1d1d,font-weight:bold,font-size:14px,stroke-width:3px

    style UserLayer fill:#fffbeb,stroke:#b45309,color:#78350f,font-weight:bold,stroke-width:3px
    style APILayer fill:#eff6ff,stroke:#2563eb,color:#1e3a8a,font-weight:bold,stroke-width:3px
    style Processing fill:#f8fafc,stroke:#475569,color:#1e293b,font-weight:bold,stroke-width:3px
    style Memory fill:#f5f3ff,stroke:#7c3aed,color:#4c1d95,font-weight:bold,stroke-width:3px
    style Execution fill:#fffbeb,stroke:#b45309,color:#78350f,font-weight:bold,stroke-width:3px
    style ExternalAI fill:#eff6ff,stroke:#2563eb,color:#1e3a8a,font-weight:bold,stroke-width:3px
    style Frontend fill:#fef3c7,stroke:#b45309,color:#78350f,font-weight:bold,stroke-width:3px
    style PostDebate fill:#f0fdf4,stroke:#059669,color:#064e3b,font-weight:bold,stroke-width:3px
    style Persistence fill:#ecfdf5,stroke:#059669,color:#064e3b,font-weight:bold,stroke-width:3px
```
